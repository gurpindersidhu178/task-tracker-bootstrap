# 🎯 Rules of Engagement - Task Tracker

Welcome to the **Task Tracker Assignment**! This document outlines the rules, expectations, and guidelines for completing your technical assessment.

## 📋 Assignment Overview

You are tasked with building a task tracker application. This is a **real-world project** that demonstrates your ability to work with modern web technologies and follow professional development practices.
